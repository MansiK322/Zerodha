...
function CreateTicket() {
    return (
      ...
      <div className='col-4 p-5 mt-2 mb-2'>
        <h4 className='' style={{fontSize:"fs-1"}}><i class="fa fa-user" aria-hidden="true"></i> Your Zerodha Account</h4>
      ...
      <div className='col-4 p-5 mt-2 mb-2'>
        <h4 className=''><i class="fa fa-window-maximize" aria-hidden="true"></i> Funds</h4>
      ...
      <div className='col-4 p-5 mt-2 mb-2'>
        <h4 className=''><i class="fa fa-dot-circle-o" aria-hidden="true"></i> Coin</h4>
