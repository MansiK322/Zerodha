...
import ecosystemImage from '../../assets/ecosystem.png'; // Update the image path based on your assets folder location
    ...
    return (
        <div className='container p-3'>
            <div className='row p-5'>
                ...
                <div className='col-6 p-5'>
                    <img src={ecosystemImage} style={{width:"90%"}} alt="Ecosystem" />
